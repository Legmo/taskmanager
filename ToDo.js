<БЛИЖАЙШИЕ /> {
  ...
  - Таблица - шапку собирать через map
  - Сортировка + пагинация при условии сортировки по разным колонкам
      ...
      - правильно обрабатывать первый клик
      - изначально задавать параметры сортировки + выводить индикаторы
      - получать/выводить верные данные после ручной сортировки

  - Отправка данных на бэкенд (форма, админка) {
    - Форма {
